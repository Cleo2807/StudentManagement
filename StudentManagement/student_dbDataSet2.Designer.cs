...
namespace StudentManagement {
    ...
    public partial class student_dbDataSet2 : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(int Id, string StudentName, string FatherName, string MotherName, int Class, string City) {
...
namespace StudentManagement.student_dbDataSet2TableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([Id] = @Original_Id) AND ([StudentName] = @Or" +
                "iginal_StudentName) AND ([FatherName] = @Original_FatherName) AND ([MotherName] " +
                "= @Original_MotherName) AND ([Class] = @Original_Class) AND ([City] = @Original_" +
                "City))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Id], [StudentName], [FatherName], [MotherName], [Cl" +
                "ass], [City]) VALUES (@Id, @StudentName, @FatherName, @MotherName, @Class, @City" +
                ");\r\nSELECT Id, StudentName, FatherName, MotherName, Class, City FROM Student WHE" +
                "RE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Id] = @Id, [StudentName] = @StudentName, [FatherName] = @FatherName, [MotherName] = @MotherName, [Class] = @Class, [City] = @City WHERE (([Id] = @Original_Id) AND ([StudentName] = @Original_StudentName) AND ([FatherName] = @Original_FatherName) AND ([MotherName] = @Original_MotherName) AND ([Class] = @Original_Class) AND ([City] = @Original_City));
SELECT Id, StudentName, FatherName, MotherName, Class, City FROM Student WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::StudentManagement.Properties.Settings.Default.student_dbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, StudentName, FatherName, MotherName, Class, City FROM dbo.Student";
        ...
        public virtual int Fill(student_dbDataSet2.StudentDataTable dataTable) {
        ...
        public virtual student_dbDataSet2.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            student_dbDataSet2.StudentDataTable dataTable = new student_dbDataSet2.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(student_dbDataSet2.StudentDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_StudentName, string Original_FatherName, string Original_MotherName, int Original_Class, string Original_City) {
        ...
        public virtual int Insert(int Id, string StudentName, string FatherName, string MotherName, int Class, string City) {
        ...
        public virtual int Update(int Id, string StudentName, string FatherName, string MotherName, int Class, string City, int Original_Id, string Original_StudentName, string Original_FatherName, string Original_MotherName, int Original_Class, string Original_City) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string StudentName, string FatherName, string MotherName, int Class, string City, int Original_Id, string Original_StudentName, string Original_FatherName, string Original_MotherName, int Original_Class, string Original_City) {
            return this.Update(Original_Id, StudentName, FatherName, MotherName, Class, City, Original_Id, Original_StudentName, Original_FatherName, Original_MotherName, Original_Class, Original_City);
        }
    }
